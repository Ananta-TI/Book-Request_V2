        ...
        <section className="bg-[#1a2129] text-white">
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 py-16">
            ...
            <p className="mt-5 text-[16px] leading-[1.55] text-[#bbbbbb] font-light max-w-2xl">
              Ajukan permintaan buku baru untuk kebutuhan pembelajaran atau referensi.
            </p>
          </div>
        </section>
          ...
          <form onSubmit={handleSubmit} className="border border-[#e6e6e6] bg-white">
            ...
            <div className="p-6 lg:p-8 space-y-8">
              ...
              <Field label="Judul Buku">
                <input type="text" name="title" value={form.title} onChange={handleChange} placeholder="Masukkan judul buku" required className="input-bmw" />
              </Field>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Field label="Estimasi Harga">
                  <input type="number" name="estimatedPrice" value={form.estimatedPrice} onChange={handleChange} placeholder="Contoh: 150000" min="0" className="input-bmw" />
                </Field>
            ...
            <div className="border-t border-[#e6e6e6] px-6 lg:px-8 py-5 flex flex-col sm:flex-row justify-end gap-3">
              ...
              <button type="submit" disabled={loading} className="btn-primary-bmw disabled:bg-[#d6d6d6] disabled:text-[#6b6b6b]">
                {loading ? "MENYIMPAN..." : "KIRIM REQUEST BUKU"}
              </button>
            </div>
          </form>
        </section>
